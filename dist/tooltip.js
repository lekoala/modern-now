...
`,se="tooltip-style";vt(ie,se);var G=Mt(),It=["mouseover","mouseout","focus","blur","click"],zt=[D,E];function jt(t){G&&t.showPopover(),bt(t),S(E,t)}function Ut(t){G&&t.hidePopover(),B(t)}var Bt=t=>{let e=N(t.target,"div"),o=N(e.closest("[data-tooltip]"),"a"),n=o.dataset,r=M(n.tooltipTarget);if(!r)return;let s=t.type==="click",p=k(o,"tooltipClick"),l=k(o,"tooltipVisible"),h=k(o,"tooltipHidden"),f=null;p?s&&(t.preventDefault(),f=z(r)?"hide":"show"):s||(f=["mouseover","focus"].includes(t.type)?"show":"hide"),f==="show"?!h&&!z(r)&&jt(r):f==="hide"&&!l&&(document.activeElement!==e||s)&&Ut(r)},Ft=t=>{let e=t.target,o=t.type,n=e.dataset;if(o===E){let r=M(n.tooltipElement);Vt(r,e,{placement:n.tooltipPlacement,distance:n.tooltipDistance,flip:!0,shift:!0,shiftPadding:6})}o===D&&!e.dataset.tooltipVisible&&Ut(e)},Nt=new WeakMap,Q=0;Lt("[data-tooltip]",t=>{let e,o=t.dataset,n=kt(o.tooltip);wt(t,n,["distance","placement","target","class","title","visible","hidden"],"tooltip"),n.hidden&&(o.tooltipHidden="true"),n.visible&&(o.tooltipVisible="true"),n.click&&(o.tooltipClick="true");let r=H(t,"href");!n.target&&r&&r.indexOf("#")===0&&(n.target=r.substring(1));let s=n.title||H(t,"title");if(s?(ft(t,"title"),Q++,e=F("div"),e.id=`tooltip-${Q}`,e.style.maxWidth="40ch",e.innerHTML=`${s}`,(t.closest("dialog")||document.body).appendChild(e),o.tooltipTarget=e.id):n.target&&(e=M(n.target),o.tooltipTarget=n.target),!e)return;ut(t,"aria-describedby",`tooltip-${Q}`),e.style.position="fixed",G&&(e.popover=""),n.visible?e.dataset.tooltipVisible="true":B(e),L(e,"tooltip"),e.role="tooltip",e.inert=!0,e.tabIndex=-1,n.class&&L(e,n.class),t.id||(t.id=`${e.id}-target`),pt(e,{tooltipPlacement:n.placement||"top",tooltipDistance:n.distance||"6",tooltipElement:t.id}),b(zt,Ft,e);let p=Rt(e);Nt.set(e,p),b(It,Bt,t),n.visible&&jt(e)},t=>{let e=M(t.dataset.tooltipTarget);e&&(R(zt,Ft,e),C(Nt,e),e.remove()),R(It,Bt,t)});
