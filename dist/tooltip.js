...
`,ae="tooltip-style";bt(se,ae);var J=$t(),jt=["mouseover","mouseout","focus","blur","click"],zt=[H,M];function Ut(t){J&&t.showPopover(),yt(t),k(M,t)}function Kt(t){J&&t.hidePopover(),z(t)}var Nt=t=>{let e=q(t.target,"div"),o=q(e.closest("[data-tooltip]"),"a"),n=o.dataset,r=S(n.tooltipTarget);if(!r)return;let s=t.type==="click",u=A(o,"tooltipClick"),l=A(o,"tooltipVisible"),h=A(o,"tooltipHidden"),f=null;u?s&&(t.preventDefault(),f=j(r)?"hide":"show"):s||(f=["mouseover","focus"].includes(t.type)?"show":"hide"),f==="show"?!h&&!j(r)&&Ut(r):f==="hide"&&!l&&(document.activeElement!==e||s)&&Kt(r)},qt=t=>{let e=t.target,o=t.type,n=e.dataset;if(o===M){let r=S(n.tooltipElement);Bt(r,e,{placement:n.tooltipPlacement,distance:n.tooltipDistance,flip:!0,shift:!0,shiftPadding:6})}o===H&&!e.dataset.tooltipVisible&&Kt(e)},Ft=new WeakMap,_=0;Wt("[data-tooltip]",t=>{let e,o=t.dataset,n=St(o.tooltip);At(t,n,["distance","placement","target","class","title","visible","hidden"],"tooltip"),n.hidden&&(o.tooltipHidden="true"),n.visible&&(o.tooltipVisible="true"),n.click&&(o.tooltipClick="true");let r=P(t,"href");!n.target&&r&&r.indexOf("#")===0&&(n.target=r.substring(1));let s=n.title||P(t,"title");if(s?(dt(t,"title"),_++,e=N("div"),e.id=`tooltip-${_}`,e.style.maxWidth="40ch",e.innerHTML=`${s}`,(t.closest("dialog")||document.body).appendChild(e),o.tooltipTarget=e.id):n.target&&(e=S(n.target),o.tooltipTarget=n.target),!e)return;ft(t,"aria-describedby",`tooltip-${_}`),e.style.position="fixed",J&&(e.popover=""),n.visible?e.dataset.tooltipVisible="true":z(e),L(e,"tooltip"),e.role="tooltip",e.inert=!0,e.tabIndex=-1,n.class&&L(e,n.class),t.id||(t.id=`${e.id}-target`),ut(e,{tooltipPlacement:n.placement||"top",tooltipDistance:n.distance||"6",tooltipElement:t.id}),b(zt,qt,e);let u=It(e);Ft.set(e,u),b(jt,Nt,t),n.visible&&Ut(e)},t=>{let e=S(t.dataset.tooltipTarget);e&&(V(zt,qt,e),w(Ft,e),e.remove()),V(jt,Nt,t)});
